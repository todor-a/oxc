...
impl Rule for Named {
    fn run_once<'a>(&self, ctx: &LintContext<'a>) {
        ...
        // module_record.resolved_module_requests.read().unwrap();
        // let module_request_name = import_entry.module_request.name();
        // let Some(remote_module_path) =
        // resolved_module_requests.get(module_request_name)
        // else {
        // continue;
        // };
